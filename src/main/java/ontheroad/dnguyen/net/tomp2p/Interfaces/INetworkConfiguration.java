...
public interface INetworkConfiguration {
     ...
     * the port will automatically be assigned (starting from {@link OTRConst#OTR_PORT}).
     *
     ...
     * port-forwarding. The default port of Hive2Hive is {@link OTRConst#OTR_PORT}. This port is
